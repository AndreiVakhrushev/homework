...
async def get_buying_list(message):
    with open('B-Complex.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Product1 | Описание: Железо (65mg) 365 штук |'
                                        f' Цена: {3100}руб.')
    with open('C.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Product2 | Описание: Витамин С (1000mg) 365 штук |'
                                        f' Цена: {5000}руб.')
    with open('D3.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Product3 | Описание: Витамин D3 (2000mg) 320 капсул |'
                                        f' Цена: {3200}руб.')
    with open('Fish Oil.jpg', 'rb') as img:
        await message.answer_photo(img, f'Название: Product4 | Описание: Комплекс Омега (1200mg) 200 капсул |'
                                        f' Цена: {5400}руб.')
